...
export class SimulationEngine {
    ...
    /**
     * @param {number} grid_radius
     */
    constructor(grid_radius) {
        const ret = wasm.simulationengine_new(grid_radius);
     ...
     */
    tick(steps) {
        wasm.simulationengine_tick(this.__wbg_ptr, steps);
    }
    /**
     * @param {number} years_per_tick
     */
    set_timescale(years_per_tick) {
        wasm.simulationengine_set_timescale(this.__wbg_ptr, years_per_tick);
    }
    reset() {
    ...
    snapshot_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.simulationengine_snapshot_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('civilization_simulator_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
